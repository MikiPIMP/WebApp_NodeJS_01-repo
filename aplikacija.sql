...
-- Dumping structure for table aplikacija.article-price
DROP TABLE IF EXISTS `article-price`;
CREATE TABLE IF NOT EXISTS `article-price` (
...
-- Dumping data for table aplikacija.article-price: ~0 rows (approximately)
DELETE FROM `article-price`;
/*!40000 ALTER TABLE `article-price` DISABLE KEYS */;
/*!40000 ALTER TABLE `article-price` ENABLE KEYS */;
